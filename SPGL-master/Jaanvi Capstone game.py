...
#Words List 
words = ["sacred", "adult", "dwarves", "because", "whatever", "hangman", "chairs", "backpack", "bodywash", "clothing",
"computer", "python", "program", "glasses","sweatpant", "mattress", "friends", "clocks", "biology","algebra", "suitcase",
"knives", "ninjas", "shampoo", "madeline", "okay", "because", "whatever", "oxygen", "zombie", "genre", "rhythm",
"ninety", "restaurant", "niece", "ridiculous", "onions", "cabbage", "whisky", "tasty", "mixed", "edge", "boiled", "pancake", "inside", "outside"]
#Create classes
